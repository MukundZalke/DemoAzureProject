...
public class WebConnector {
	...
	public static final String USERNAME = "nabinghosh1";
	public static final String AUTOMATE_KEY = "Sq1tNwoQiKoVrxy44Ky6";
	...
	public void openBrowser(String browserName) throws MalformedURLException {
		if(prop.getProperty("gridRun").equals("Y")) {
			...
			if(browserName.equals("Mozilla"))
			    ...
			    caps.setCapability("name", "Global Test Retreat 2019 Sample Test");
	...
	public void navigate(String urlKey) throws MalformedURLException {
